...
const HeroSection = () => {
  return (
    <>
       <section className="flex w-screen  items-center justify-center lg:gap-10 lg:flex-nowrap sm:flex-wrap">
          <div className="left-part lg:w-2/5 sm:w-screen flex items-center justify-center">
            <img src="http://www.freepngimg.com/download/shopping/7-2-shopping-png-hd.png" className="w-screen"/>
          </div>
